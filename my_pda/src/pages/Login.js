...
const Login = (props) => {
    ...
    return (
                ...
                <div class="py-16 mt-12">
                    ...
                    <div className="hidden lg:block lg:w-1/2 bg-cover" style={backgroundImage}></div>
                        <div class="w-full p-8 lg:w-1/2">
                            ...
                            <div class="mt-8">
                                <button type = "submit" class="bg-[#426B1F] hover:bg-[#486a2a] text-white font-bold py-2 px-4 w-full rounded" >Login</button>
                            </div>
                            </form>
                            <div class="mt-4 flex items-center justify-between">
                                <span class="border-b w-1/5 md:w-1/4"></span>
                                <a href="/signin" class="text-xs text-gray-500 uppercase">or sign up</a>
                                <span class="border-b w-1/5 md:w-1/4"></span>
                            </div>
                        </div>
                    </div>
